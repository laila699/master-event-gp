...
class VendorService {
  final Dio _dio;
  VendorService(this._dio); // Constructor for VendorService
  Future<List<User>> listVendors({
    required VendorServiceType type, // The type of vendor service 
    String? city,
    double? lat,
    double? lng,
    double? radiusKm,
    ...
    final qp = <String, dynamic>{
      'serviceType': type.value, // Convert enum to string value
  ...
  Future<ProviderModel> fetchProviderModel(String vendorId) async { // Fetch provider model by vendor ID
