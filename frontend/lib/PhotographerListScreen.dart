  ...
  final List<Map<String, dynamic>> initialPhotographers = [
    {
      ...
      'rating': 4.7,
      'phone': '0599123456',
      'photographyTypes': ['وثائقي', 'برومو رحل'],
      'tripTypes': ['رحلة مسارات', 'رحل ثقافية'],
    ...
    },
    {
      ...
      'rating': 4.5,
      'phone': '0599876543',
      'photographyTypes': ['سينمائي'],
      'tripTypes': ['رحلة تخييم', 'رحلة مغامرات'],
    ...
    },
    {
      ...
      'rating': 4.9,
      'phone': '0591112233',
      'photographyTypes': [' كلاسيكي'],
      'tripTypes': [' رحلة دينية', ' رحل ثقافية'],
    ...
    },
    {
      ...
      'tripTypes': ['رحلة مسارات', ' رحلة بحرية'],
      ...
      _filteredPhotographers =
          widget.initialPhotographers.where((photographer) {
            ...
            final eventTypeMatch =
                ...
                (photographer['tripTypes'] as List).contains(_selectedTripType);
