...
class _ReservationScreenState extends State<ReservationScreen> {
  ...
  String? _selectedTripType; // متغير لتخزين نوع الرحلة المحدد
  ...
  void _calculatePrice() {
    ...
    // مثال:
    // if (_selectedTripType == 'برايدل شور') {
  ...
  void _submitReservation() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          "تم الحجز بنجاح! نوع الرحلة: $_selectedTripType، لعدد ${_peopleCountController.text} شخص بسعر تقديري ${_estimatedPrice.toStringAsFixed(2)} ريال.",
        ),
      ),
    );
