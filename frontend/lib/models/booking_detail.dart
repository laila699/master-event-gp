...
class BookingDetail {
  ...
  final int quantity;
  final DateTime scheduledAt; //اذا مو موجود بياخد createdAt
  final String? note;
  final String status;
  final bool rated;
  ...
  factory BookingDetail.fromJson(Map<String, dynamic> json) {
    // parse nested event
    final ev = Trip.fromJson(json['event'] as Map<String, dynamic>);
    // offering + vendor
    ...
    return BookingDetail(
      ...
      offeringImages: List<String>.from(
        offJson['images'] ?? [],
      ), // convert to List<String>
      offeringPrice: (offJson['price'] as num).toDouble(), // convert to double
      quantity: (json['quantity'] as num).toInt(), // convert to int
      scheduledAt:
