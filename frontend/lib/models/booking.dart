...
class Booking {
  ...
  factory Booking.fromJson(Map<String, dynamic> json) {
    ...
    String extractId(dynamic field) {
      if (field is String) return field; // If it's a string, use it directly
      if (field is Map<String, dynamic> && field['_id'] is String) {
        return field['_id'] as String; // If it's a map, extract the ID
      }
      return ''; // Default to empty string if ID is not found
    }
