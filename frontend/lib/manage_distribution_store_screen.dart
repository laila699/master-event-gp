...
// تعريف كلاس لمساعدة في إدارة حقول المعدات المحددة
...
class _ManageDistributionStoreScreenState
  ...
  void initState() {
    ...
    // تعبئة حقول أنواع المعدات المقدمة
    if (widget.distributionStore != null &&
    ...
    // تعبئة حقول المعدات المحددة (Specific Distributions)
    if (widget.distributionStore != null &&
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          isEditing ? 'تعديل بيانات متجر المعدات' : 'إضافة متجر مععدات جديد',
                ...
                showDialog(
                  ...
                  builder:
                      (ctx) => AlertDialog(
                        ...
                        content: Text(
                          'هل أنت متأكد من رغبتك في حذف متجر المعدات هذا؟',
                          style: GoogleFonts.cairo(),
                        ),
                        actions: [
                          TextButton(
          ...
          child: Column(
            ...
            children: [
              _buildTextField(
                ...
                label: 'اسم متجر المعدات',
                hint: 'مثال: لمسة فنية للمعدات',
                validator: (value) {
              ...
              _buildTextField(
                ...
                hint: 'نصمم معدات فريدة لكل رحلة...',
                validator: (value) {
                  if (value == null || value.isEmpty) {
              ...
              // أنواع الرحل التي يغطيها المتجر
              _buildDynamicTextFieldsSection(
                label: 'أنواع الرحل التي يغطيها المتجر:',
                hint: 'مثال: ثقافية, دينية, مغامرات',
              ...
              // أنواع المعدات المقدمة
              _buildDynamicTextFieldsSection(
                label: 'أنواع المعدات المقدمة:',
                hint: 'مثال:  حقيبة, شموع',
              ...
              // المعدات المحددة (specific_distributions)
              Text(
                'المعدات المحددة (منتجات المتجر):',
                style: GoogleFonts.cairo(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildTextField(
                            ...
                            label: 'مكونات الغرض',
                            hint: 'مثال:  سحاب, ازرار ',
                            maxLines: 2,
                          ),
                          const SizedBox(height: 10),
                          // أنواع  الرحلة لهذا الغرض
                          Text(
                            'رحلة لـ (لهذا الغرض):',
                            style: GoogleFonts.cairo(
                              fontSize: 16,
  ...
  // دالة مساعدة لبناء أقسام الحقول الديناميكية العامة (صور المعرض، أنواع المناسبات، أنواع المعدات)
