...
class _PhotographerReservationScreenState
  ...
  String? _location;
  String? _duration;
  String? _selectedTripType; // إضافة لتحديد نوع الرحلة للحجز
  ...
  void _submitReservation() {
    ...
    if (_selectedTripType == null || _selectedTripType!.isEmpty) {
      ScaffoldMessenger.of(
        context,
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'تم إرسال طلب حجز لـ ${widget.photographerName} بتاريخ ${_selectedDate!.day}/${_selectedDate!.month}/${_selectedDate!.year} في موقع $_location لمدة $_duration لرحلة $_selectedTripType.',
        ),
              ...
              DropdownButtonFormField<String>(
                items:
                    tripTypes
                        ...
                        .toList(),
                onChanged: (value) => setState(() => _selectedTripType = value),
                decoration: InputDecoration(
