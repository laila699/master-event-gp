...
router.post(
  "/sections/:sectionId/items", // Create a new item in a section
  uploadOfferingImages.single("image"), // يرفع صورة
  createMenuItem
);
router.get("/sections/:sectionId/items", listMenuItems); //جلب كل العناصر لقسم معين.
router.put(
